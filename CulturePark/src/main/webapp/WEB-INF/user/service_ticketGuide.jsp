        ...
        <div class="innerContainer">
                        ...
                        <div class="guide_content guide_pc">
                            <ul class="description_wrap">
                                <li class="descript_list">
                                    <div class="descript_head">Step 1<div class="descript_text">원하는 상품의 예매하기 버튼 클릭</div></div>
                                    <div class="descript_img">
                                        <img src="/resources/user/resource/service/ticketGuide_m_01.png">
                                    </div>
                                </li>
                                <li class="descript_list">
                                    <div class="descript_head">Step 2 <div class="descript_text">원하는 날짜 선택</div></div>
                                    <div class="descript_img">
                                        <img src="/resources/user/resource/service/ticketGuide_m_02.png">
                                    </div>
                                </li>
                                <li class="descript_list">
                                    <div class="descript_head">Step 3 <div class="descript_text">원하는 시간대 선택</div></div>
                                    <div class="descript_img">
                                        <img src="/resources/user/resource/service/ticketGuide_m_03.png">
                                    </div>
                                </li>
                                <li class="descript_list">
                                    <div class="descript_head">Step 4 <div class="descript_text">유형별 인원 수 선택</div></div>
                                    <div class="descript_img">
                                        <img src="/resources/user/resource/service/ticketGuide_m_04.png">
                                    </div>
                                </li>
                                <li class="descript_list">
                                    <div class="descript_head">Step 5 <div class="descript_text">결제하기 클릭</div></div>
                                    <div class="descript_img">
                                        <img src="/resources/user/resource/service/ticketGuide_m_05.png">
                                    </div>
                                </li>
                                <li class="descript_list">
                                    <div class="descript_head">Step 6 <div class="descript_text">결제 진행</div></div>
                                    <div class="descript_img">
                                        <img src="/resources/user/resource/service/ticketGuide_m_06.png">
                                    </div>
                                </li>
            ...
            <div class="quickContainer">
                <ul class="quick_wrap">
                    ...
                    <li class="quickList"><a class="quick_link" href="#">발권안내</a></li>
