                    ...
                    <div class="board_content">
                        ...
                        <div class="board_info">
                            ...
                            <div class="board_row_2"> <%--작품 이름 및 작가 이름--%>
                                ...
                                <div class="row_content">
                                    <div class="span_head">작성자</div><div class="review_writer">김진아</div>
                                </div>
                            </div>
...
<%--    &lt;%&ndash;  css 불러오기  &ndash;%&gt;--%>
<%--    <style><%@include file="/resources/common/css/reset.css"%> </style>--%>
<%--    <style><%@include file="/resources/common/css/common.css"%></style>--%>
<%--    <style><%@include file="/resources/common/css/header.css"%></style>--%>
<%--    <style><%@include file="/resources/user/css/main_slider.css"%></style>--%>
<%--    <style><%@include file="/resources/user/css/main_productPage.css"%></style>--%>
...
<%--    &lt;%&ndash; Contents 영역 &ndash;%&gt;--%>
<%--    <div class="centerContainer">--%>
<%--        &lt;%&ndash; 이곳에 페이지를 import &ndash;%&gt;--%>

<%--            &lt;%&ndash; 프로모션 섹션 &ndash;%&gt;--%>
<%--            <div class="ex_promotion_section">--%>
<%--                <div class="section_name">--%>
<%--                    <span class="section_title">프로모션</span>--%>
<%--                </div>--%>
<%--                <div class="section_page">--%>
<%--                    <span id="ex_page_num">1</span><span>/2</span>--%>
<%--                </div>--%>
...
<%--            &lt;%&ndash; 랭킹 섹션 &ndash;%&gt;--%>
<%--            <div class="gallery_section_pc">--%>
<%--                <ul class="gallery_box">--%>
<%--                    <li class="gallery_list">--%>
<%--                        <div class="gal_number"></div>--%>
<%--                        <div class="gal_img"><img src="/resources/user/resource/home/ex_prom_01.png"></div>--%>
<%--                        <div class="gal_title"></div>--%>
<%--                    </li>--%>
<%--                    <li class="gallery_list">--%>
<%--                        <div class="gal_number"></div>--%>
<%--                        <div class="gal_img"><img src="/resources/user/resource/home/ex_prom_02.png"></div>--%>
<%--                        <div class="gal_title"></div>--%>
<%--                    </li>--%>
<%--                    <li class="gallery_list">--%>
<%--                        <div class="gal_number"></div>--%>
<%--                        <div class="gal_img"><img src="/resources/user/resource/home/ex_prom_03.png"></div>--%>
<%--                        <div class="gal_title"></div>--%>
<%--                    </li>--%>
<%--                </ul>--%>
<%--            </div>--%>

<%--            <div class="gallery_section_mobile">--%>
<%--                <ul class="gallery_box_m">--%>
<%--                    <li class="gallery_list_m">--%>
<%--                        <div class="gal_number"></div>--%>
<%--                        <div class="gal_img"><img></div>--%>
<%--                        <div class="gal_title"></div>--%>
<%--                    </li>--%>
<%--                    <li class="gallery_list_m">--%>
<%--                        <div class="gal_number"></div>--%>
