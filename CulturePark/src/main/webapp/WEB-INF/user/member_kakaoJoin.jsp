...
<%@ taglib prefix="font-size" uri="http://struts.apache.org/tags-html" %>
<!DOCTYPE html>
<html>
<head>
  ...
  <style><%@include file="/resources/user/css/member_kakaoJoin.css" %></style>

  <title> kakaoJoin </title>

   <%-- <script>
    window.onload = function() { alert("기존 회원 확인을 위해 먼저 핸드폰 번호 입력후, 인증번호를 입력해주세요"); };
    </script>
--%>
...
<div class="mainContainer">
  ...
  <div class="centerContainer">
      ...
      <form id="frm">
        <div class="join_section">
          ...
          <div class="name_section section_type01">
            ...
            <input class="name_value input_type01" type="textFiled" name="name_value" maxlength="5" disabled="disabled">
          </div>

          <div class="jumin_section section_type01">
            <div class="jumin_label">주민번호</div>
            <input class="jumin_value1" type="textFiled" name="jumin_value1" maxlength="6" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" disabled="disabled"> -
            <input class="jumin_value2" type="textFiled" name="jumin_value2" maxlength="1" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" disabled="disabled"> ******
          </div>
      ...
      <div class="agree_condition_section">
        ...
        <div class="agree_condition_all_section">
          <div class="agree_condition_all">
            <input type="checkbox" class="checkbox_agree checkbox_all checkbox_all_p" disabled="disabled">
        ...
        <div class="agree_1">
          ...
          <div class="checkbox_section">
            <input type="checkbox" name="chk" class="checkbox_agree checkbox_one" disabled="disabled">
        ...
        <div class="join_btn_section">
          <input type="button" class="join_btn" name="join_btn" value="회원가입" disabled="disabled">
        </div>
    ...
    <div id="mergeJoinModal" class="modal">
      <div class="modal-content">
        <p style="text-align:center;">
       <span style="font-size:14pt;"><b>
       <span style="font-size:20pt;">알림</span></b>
    ...
    <div id="kakaoJoinModal" class="modal">
      <div class="modal-content">
        <p style="text-align:center;">
       <span style="font-size:14pt;"><b>
       <span style="font-size:20pt;">알림</span></b>
...
<script src="/resources/user/js/member_kakaoJoin.js"></script>
