...
<div class="mainContainer">
    ...
    <div class="centerContainer">
            ...
            <div class="button_section">
                <div class="btn_content_select">
                    <ul class="btn_c_s_box">
                        <li id="c_s_01_m" class="btn_content_list"><button>이 용 정 보</button></li>
                        <li id="c_s_02_m" class="btn_content_list"><button>부 가 정 보</button></li>
                        <li id="c_s_03_m" class="btn_content_list"><button>이 용 후 기</button></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="sideContainer">
            <div class="side_section_p"></div>

            <div class="side_section_m"></div>
        </div>
    </div>
